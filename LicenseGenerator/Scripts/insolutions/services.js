app.factory('inDateFormatter', function () {
    function DateFormatter() {
    }

    DateFormatter.prototype.customFormatDate = function (dateObject, formatString) {
...
app.factory('inLicenseFormatter', function (inDateFormatter) {
    return {
